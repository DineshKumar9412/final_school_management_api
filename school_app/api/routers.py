...
from api.gallery_web import gallery_web_router
from api.event_web import event_web_router
from api.banner_web import banner_web_router
from api.online_class_web import online_class_web_router
from api.notice_web import notice_web_router
...
ROUTERS = [
    ...
    (gallery_web_router,      "/api/web/admin"),
    (event_web_router,        "/api/web/admin"),
    (banner_web_router,       "/api/web/admin"),
    (online_class_web_router, "/api/web/admin"),
    (notice_web_router,       "/api/web/admin"),
