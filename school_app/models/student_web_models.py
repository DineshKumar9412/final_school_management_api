...
class StudentInquiry(Base):
    __tablename__ = "student_admission_inquiries"

    student_inq_id: Mapped[int] = mapped_column(
    ...
    guardian_gender: Mapped[str] = mapped_column(
        Enum("male", "female", "other", name="guardian_gender_enum"),
        nullable=True
    )
...
class Student(Base):
    ...
    gender: Mapped[str] = mapped_column(
        Enum("male", "female", "other", name="student_gender_enum"),
        nullable=True)
